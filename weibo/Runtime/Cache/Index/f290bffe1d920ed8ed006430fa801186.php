...
<head>
    ...
    <script type='text/javascript'>
        ...
        var delWeibo = '<?php echo U(GROUP_NAME."/Index/delWeibo");?>';
    </script>
...
<!--==========内容主体==========-->
	...
	<div id='userinfo'>
		<div class='info-list'>
			<div class='info-face'>
				<p>
					<img src="<?php if($userinfo["face180"]): ?>__ROOT__/Uploads/Face/<?php echo ($userinfo["face180"]); else: ?>__PUBLIC__/Images/noface.gif<?php endif; ?>" width='180' height='180' alt="<?php echo ($userinfo["username"]); ?>" />
				</p>
				<ul>
					<li>
        	...
        	<dl>
                ...
                <?php if(is_array($follow)): foreach($follow as $key=>$v): ?><dd>
        			<a href="<?php echo U('/' . $v['uid']);?>">
        				<img src="<?php if($v["face"]): ?>__ROOT__/Uploads/Face/<?php echo ($v["face"]); else: ?>__PUBLIC__/Images/noface.gif<?php endif; ?>" alt="<?php echo ($v["username"]); ?>" width='50' height='50'/>
        			</a>
        			<p>
        				<a href="<?php echo U('/' . $v['uid']);?>"><?php echo ($v["username"]); ?></a>
        			</p>
