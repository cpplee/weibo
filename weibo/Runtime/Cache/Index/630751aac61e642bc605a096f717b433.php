...
<head>
	...
	<link rel="stylesheet" href="__PUBLIC__/Theme/default/Css/comment.css" />
    ...
    <script type="text/javascript">
        var replyUrl = "<?php echo U(GROUP_NAME.'/User/reply');?>";
        var delComment = "<?php echo U(GROUP_NAME.'/User/delComment');?>";
    </script>
<script type="text/javascript">
...
<div style='height:60px;opcity:10'></div>
    ...
    <!--=====中部=====-->
        ...
        <?php if(is_array($comment)): foreach($comment as $key=>$v): ?><dl>
				<dt>
					<a href="<?php echo U('/' . $v['uid']);?>"><img src="<?php if($v["face"]): ?>__ROOT__/Uploads/Face/<?php echo ($v["face"]); else: ?>__PUBLIC__/Images/noface.gif<?php endif; ?>" width='50' height='50'/></a>
				</dt>
				<dd>
