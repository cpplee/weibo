...
<head>
	...
	<script type='text/javascript'>
		var checkAccount = "<?php echo U(GROUP_NAME.'/Login/checkAccount');?>";
		var checkUname = "<?php echo U(GROUP_NAME.'/Login/checkUname');?>";
		var checkVerify = "<?php echo U(GROUP_NAME.'/Login/checkVerify');?>";
	</script>
...
<body>
	<div id='logo'></div>
	<div id='reg-wrap'>
		<form action="<?php echo U(GROUP_NAME.'/Login/runRegis');?>" method='post' name='register'>
			<fieldset>
				<legend>用户注册</legend>
				<p>
				...
				<p>
					...
					<img src="<?php echo U(GROUP_NAME.'/Login/verify');?>" width='80' height='25' id='verify-img'/>
				</p>
				<p class='run'>
