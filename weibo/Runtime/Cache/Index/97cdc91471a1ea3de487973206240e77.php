...
<head>
	...
	<link rel="stylesheet" href="__PUBLIC__/Css/sech_user.css" />
...
<!--==========内容主体==========-->
    ...
    <!--==========创建分组==========-->
        <div id='right'>
    		...
    		<div id='sech'>
    			<div>
	    			<form action="<?php echo U(GROUP_NAME.'/Search/sechUser');?>" method='get' name="search">
    			...
    			<ul>
                    <li><span class='cur sech-type' url="<?php echo U(GROUP_NAME.'/Search/sechUser');?>">找人</span></li>
    				<li><span class='sech-type' url="<?php echo U(GROUP_NAME.'/Search/sechWeibo');?>">微博</span></li>
    			</ul>
    		</div>
