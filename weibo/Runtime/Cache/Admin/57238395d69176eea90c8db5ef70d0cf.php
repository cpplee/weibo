	...
	<table class='table'>
		...
		<?php if(is_array($users)): foreach($users as $key=>$v): ?><tr>
				...
				<td width='100' align='center'>
					<?php if($v["lock"]): ?><a href="<?php echo U(GROUP_NAME.'/User/lockUser', array('id' => $v['id'], 'lock' => 0));?>" class='add lock'>解除锁定</a>
					<?php else: ?>
						<a href="<?php echo U(GROUP_NAME.'/User/lockUser', array('id' => $v['id'], 'lock' => 1));?>" class='add lock'>锁定用户</a><?php endif; ?>
				</td>
